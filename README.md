...
Excited to share my latest Power BI Dashboard Project – Smart City Traffic Intelligence System, designed to transform raw traffic data into actionable insights for urban mobility and traffic management.

🔹 Dashboard Highlights

📍 Operations Dashboard

Total Vehicles Monitoring
...
Identified high-congestion traffic zones.
Analyzed accident-prone areas.
Evaluated traffic signal efficiency.
Tracked peak-hour traffic patterns.
Assessed weather impact on traffic flow.
...
Most Congested Area Identification
